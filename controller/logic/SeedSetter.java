...
//		
	...
	public static ArrayList<CorrectAnswer> getCorrectAnswerList(){
		...
		correctAnswerList.add(new CorrectAnswer(216,0,2,3)); //一応3個
		...
		correctAnswerList.add(new CorrectAnswer(600,10,14,15)); //変更
		...
		correctAnswerList.add(new CorrectAnswer(774,11,17,19)); // 追加
